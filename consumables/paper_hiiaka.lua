SMODS.Consumable {
    ...
    loc_vars = function(self, info_queue, center)
		return {
			vars = {
				G.GAME.hands['paperback_Straight Spectrum'].level,
				colours = {(G.GAME.hands['paperback_Straight Spectrum'].level==1 and G.C.UI.TEXT_DARK or G.C.HAND_LEVELS[math.min(7, G.GAME.hands['paperback_Straight Spectrum'].level)])}
			},
		}
    end,
	...
	use = function(self, card, area, copier)
		local hand = 'paperback_Straight Spectrum'
