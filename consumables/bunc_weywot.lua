SMODS.Consumable {
	...
	unlocked = true,
	discovered = true,
	config = { hand_type = "bunc_Spectrum", softlock = true, moon = true },
	atlas = 'consumable_atlas',
    loc_vars = function(self, info_queue, center)
		return {
			vars = {
				G.GAME.hands['bunc_Spectrum'].level,
				colours = {(G.GAME.hands['bunc_Spectrum'].level==1 and G.C.UI.TEXT_DARK or G.C.HAND_LEVELS[math.min(7, G.GAME.hands['bunc_Spectrum'].level)])}
			},
		}
    end,
