...
function process_texture_scorched(image)
	...
	love.graphics.clear({ 0.31, 0.388, 0.404, 0 })
	...
	G.SHADERS["aij_burnt_spritesheet"]:send(
		"maskUV",
		{ pos.x * enhancements_atlas.px / texW, pos.y * enhancements_atlas.py / texH, w / texW, h / texH }
	)
	G.SHADERS["aij_burnt_spritesheet"]:send(
		"otherUV",
		{ postwo.x * enhancements_atlas.px / texW, postwo.y * enhancements_atlas.py / texH, w / texW, h / texH }
	)
