					...
					func = function()
						...
						for k, _ in pairs(G.shared_stickers) do
							if G.consumeables.cards[i].ability[k] then
								...
								if k == "perishable" then
									original_stickers["perish_tally"] = G.consumeables.cards[i].ability.perish_tally
										or 5
								end
							end
						end
						...
						for k, _ in pairs(G.shared_stickers) do
							if original_stickers[k] then
								...
								if
									type(G.consumeables.cards[i].ability[k]) == "table"
									and G.consumeables.cards[i].ability[k].mult
								then
