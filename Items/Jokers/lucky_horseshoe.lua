local lucky_horseshoe = {
	...
	loc_vars = function(self, info_queue, card)
		...
		local numerator1, denominator1 =
			SMODS.get_probability_vars(card, 1, card.ability.extra.odds_money, "lucky_horseshoe")
		local numerator2, denominator2 =
			SMODS.get_probability_vars(card, 1, card.ability.extra.odds_xmult, "lucky_horseshoe")
		return {
			vars = {
				numerator1,
				denominator1,
