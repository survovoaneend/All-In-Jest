local coffee_thermos = {
	...
	calculate = function(self, card, context)
		...
		if context.end_of_round and context.main_eval then
			...
			card_eval_status_text(card, "extra", nil, nil, nil, {
				message = (card.ability.extra.rounds <= 0) and localize("k_eaten_ex")
					or (card.ability.extra.rounds .. "/" .. card.ability.extra.total_rounds),
				colour = (card.ability.extra.rounds <= 0) and G.C.RED or G.C.FILTER,
			})
