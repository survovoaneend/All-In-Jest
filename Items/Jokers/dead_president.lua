				...
				if left_joker or right_joker then
					...
					G.E_MANAGER:add_event(Event({ --Add bonus chips from this card
						...
						func = function()
							...
							if left_joker then
								left_joker.ability.extra_value = (left_joker.ability.extra_value or 0)
									+ math.min(left_joker.sell_cost, card.ability.extra.max)
								left_joker:set_cost()
							...
							if right_joker then
								right_joker.ability.extra_value = (right_joker.ability.extra_value or 0)
									+ math.min(right_joker.sell_cost, card.ability.extra.max)
