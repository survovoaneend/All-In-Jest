local the_bell = {
    ...
    all_in_jest = {
        ...
        can_use_ability = function(self, card, context)
            ...
            if active and (G.GAME.dollars - G.GAME.bankrupt_at) >= card.ability.extra.cost and (G.shop_vouchers and G.shop_vouchers.cards and G.shop_vouchers.cards[1]) then
                return true
            end
        end,
