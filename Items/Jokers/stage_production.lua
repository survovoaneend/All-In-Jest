	...
	all_in_jest = {
		can_use_ability = function(self, card)
			...
			for k, v in pairs(G.jokers.cards) do
				if
					v == card
					and G.jokers.cards[k + 1]
					and G.jokers.cards[k + 1].ability
					and (
						not G.jokers.cards[k + 1].ability.all_in_jest
						or (
							G.jokers.cards[k + 1].ability.all_in_jest
							and not G.jokers.cards[k + 1].ability.all_in_jest.has_been_rerolled
						)
					)
				then
