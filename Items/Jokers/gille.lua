						...
						definition = {
							...
							nodes = {
								...
								(G.GAME.jest_free_stultor_rerolls > 0)
										and UIBox_button({
											label = { localize("b_reroll_boss"), localize("$") .. "0" },
											button = "jest_free_reroll_boss",
											func = "jest_free_reroll_boss_button",
										})
									or (G.GAME.used_vouchers["v_retcon"] or G.GAME.used_vouchers["v_directors_cut"]) and UIBox_button({
										label = { localize("b_reroll_boss"), localize("$") .. "10" },
										button = "reroll_boss",
								...
								UIBox_button({
									label = {
										localize("b_aij_reroll_tags"),
										localize("$") .. (G.GAME.current_round.reroll_cost or 5),
									},
									button = "aij_reroll_tag",
									func = "aij_reroll_tag_button",
								}),
							},
						},
						config = {
