			...
			tag:jest_apply("+", G.C.ATTENTION, function()
				...
				elseif effect == "level_hands" then
					...
					for i = 1, math.min(times, #_poker_hands) do
						local chosen_poker_hand, chosen_index =
							pseudorandom_element(_poker_hands, pseudoseed("jest_chaos_tag"))
				...
				elseif effect == "create_consumables" then
					local consumeables_to_create = math.min(
						pseudorandom("jest_chaos_tag", 2, 3),
