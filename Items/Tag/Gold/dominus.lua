			...
			(not args.hide_single_page or cards_per_page < #pool) and {
				...
				nodes = {
					create_option_cycle({
						...
						opt_callback = "SMODS_blind_collection_page",
						current_option = 1,
						colour = G.C.RED,
						no_pips = true,
				...
				G.E_MANAGER:add_event(Event({
					func = function()
						...
						G.FUNCS.overlay_menu({
							config = { no_esc = true },
							definition = All_in_Jest.jest_blind_collection_UIBox(G.P_BLINDS, { 5, 5, 5, 5, 5, 5 }, {
								no_materialize = true,
