local circumplanetary_tag = {
	...
	loc_vars = function(self, info_queue, tag)
		...
		return {
			vars = {
				tag.config.extra and tag.config.extra.times or self.config.extra.times,
				_hand or (tag.config.extra and tag.config.extra._tag_hand or self.config.extra._tag_hand),
			},
		}
	end,
