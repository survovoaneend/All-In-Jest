...
G.FUNCS.tag_aij_nonstandard_set_enhancement = function(args)
    ...
    if G.customize_card.cards[1].config.aij_other_center ~= nil then
        other_enhancement_key = G.customize_card.cards[1].config.aij_other_center.center.key
    end
	G.E_MANAGER:add_event(Event({
		func = function()
            ...
            if other_enhancement_key ~= nil then
