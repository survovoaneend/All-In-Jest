				...
				nodes = {
					{
						...
						nodes = {
							UIBox_button({
								label = { localize("aij_button_content") },
								button = "aij_config_content",
								minw = 5,
							}),
							UIBox_button({
								label = { localize("aij_button_moons") },
								button = "aij_config_moons",
								minw = 5,
							}),
							UIBox_button({
								label = { localize("aij_button_visuals") },
								button = "aij_config_visuals",
								minw = 5,
							}),
							UIBox_button({
								label = { localize("aij_button_consistency") },
								button = "aij_config_consistency",
								minw = 5,
							}),
						},
					},
			...
			contents = {
				{
					...
					nodes = {
						{
							n = G.UIT.R,
							config = { align = "cm", padding = 0.05, emboss = 0.05, r = 0.1, colour = HEX("465255") },
							nodes = {
								{
									n = G.UIT.R,
									...
									nodes = {
										{
											n = G.UIT.T,
											config = {
												text = localize("aij_button_content"),
												colour = G.C.WHITE,
												scale = 0.8,
											},
										},
									...
									nodes = {
										{
											n = G.UIT.T,
											config = {
												text = localize("aij_button_moons"),
												colour = G.C.WHITE,
												scale = 0.8,
											},
										},
											...
											nodes = {
												{
													n = G.UIT.C,
													config = {
														tooltip = { text = localize("aij_moons_blocking_tooltip") },
													},
													nodes = {
														create_toggle({
									...
									nodes = {
										{
											n = G.UIT.T,
											config = {
												text = localize("aij_button_visuals"),
												colour = G.C.WHITE,
												scale = 0.8,
											},
										},
											...
											nodes = {
												{
													n = G.UIT.C,
													config = {
														tooltip = { text = localize("aij_red_destroy_text_tooltip") },
													},
													nodes = {
														create_toggle({
											...
											nodes = {
												{
													n = G.UIT.C,
													config = {
														tooltip = { text = localize("aij_random_deck_skins_tooltip") },
													},
													nodes = {
														create_toggle({
											...
											nodes = {
												{
													n = G.UIT.C,
													config = {
														tooltip = { text = localize("aij_alter_trypophobia_tooltip") },
													},
													nodes = {
														create_toggle({
									...
									nodes = {
										{
											n = G.UIT.T,
											config = {
												text = localize("aij_button_consistency"),
												colour = G.C.WHITE,
												scale = 0.8,
											},
										},
											...
											nodes = {
												{
													n = G.UIT.C,
													config = {
														tooltip = { text = localize("aij_mult_appearance_tooltip") },
													},
													nodes = {
														create_option_cycle({
															scale = 0.8,
