...
function All_in_Jest.pit_blinds_in_play()
	local blue_stake_replacement_blind = ((G.GAME.stake >= 5 and All_in_Jest.config.blue_stake_rework) or (G.GAME.aij_poly_chips and G.GAME.aij_poly_chips['aij_the_pit'] > 0))
